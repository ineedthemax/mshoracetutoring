          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-500 text-sm leading-relaxed">
                <p>I grew up in Maryland, where I was fortunate to have a math teacher in 7th grade who changed everything for me. He didn&apos;t just teach formulas he taught thinking. He showed me that every problem had a structure you could learn to see.</p>
                <p>I have a Bachelor&apos;s degree from Penn State University. But the classroom kept calling. I started tutoring part-time during summer breaks and never stopped.</p>
